...
class CreateApiCacheRequest(ServiceRequest):
    apiId: String
    ttl: Long
    transitEncryptionEnabled: Optional[Boolean]
    atRestEncryptionEnabled: Optional[Boolean]
...
class CreateDataSourceRequest(ServiceRequest):
    apiId: String
    name: ResourceName
    description: Optional[String]
    type: DataSourceType
...
class UpdateApiCacheRequest(ServiceRequest):
    apiId: String
    ttl: Long
    apiCachingBehavior: ApiCachingBehavior
    type: ApiCacheType
...
class AppsyncApi:
    ...
    def create_api_cache(
        ...
        type: ApiCacheType,
        transit_encryption_enabled: Boolean = None,
        at_rest_encryption_enabled: Boolean = None,
    ...
    def create_data_source(
        ...
        type: DataSourceType,
        description: String = None,
        service_role_arn: String = None,
        dynamodb_config: DynamodbDataSourceConfig = None,
        lambda_config: LambdaDataSourceConfig = None,
        elasticsearch_config: ElasticsearchDataSourceConfig = None,
        open_search_service_config: OpenSearchServiceDataSourceConfig = None,
        http_config: HttpDataSourceConfig = None,
        relational_database_config: RelationalDatabaseDataSourceConfig = None,
